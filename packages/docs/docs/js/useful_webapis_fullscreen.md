...
## 前言
全屏下播放视频已经很常见了，像这样
![](../../../../static/fullscreen.jpeg)
而在web页面里，几乎所有元素都是可以全屏显示的。全屏模式下，一切“闲杂”元素退出，
舞台只为你而亮，请开始你的表演。
![](../../../../static/blogtimg.jpeg)
...
Chrome、Safari：
![](../../../../static/fullscreen002.png)
Firefox：
![](../../../../static/fullscreen003.png)
关于样式稍后再说，我们先从头开始看。
...
![](../../../../static/blogfullscreen001.png)
所以手动改变全屏下的样式是有必要的。

而Firefox下，则看到了这样的代码，
![](../../../../static/fullscreen004.png)
