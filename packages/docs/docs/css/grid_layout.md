...
[原文链接](https://xiaotianxia.github.io/blog/vuepress/css/grid_layout.html?_=7654323456782357)
...
下文中可点击”点击展开“查看具体代码及效果，可以点击“show in codepen”跳转到codepen自行调试，如没有，请点击[原文链接](https://xiaotianxia.github.io/blog/vuepress/css/grid_layout.html?_=7654323456782357)查看原文。

先看一个例子：
![demo](http://pq3mt9wke.bkt.clouddn.com/bloggrid002.png)
...
![demo](http://pq3mt9wke.bkt.clouddn.com/grid003.jpg)

### 网格轨道(Grid Track)
两个相邻网格线之间的空间。 可以把它们想象成网格的列或行。
![demo](http://pq3mt9wke.bkt.clouddn.com/grid004.jpg)

### 网格单元(Grid Cell)
两个相邻的行和两个相邻的列网格线之间的空间。它是网格的一个“单元”。
![demo](http://pq3mt9wke.bkt.clouddn.com/grid005.jpg)

### 网格区域(Grid Area)
四个网格线包围的总空间。 网格区域可以由任意数量的网格单元组成。
![demo](http://pq3mt9wke.bkt.clouddn.com/grid006.jpg)
...
```
![demo](http://pq3mt9wke.bkt.clouddn.com/grid010.png)
...
grid-template-rows: 50px 100px;
```
![demo](http://pq3mt9wke.bkt.clouddn.com/grid011.png)
...
![demo](http://pq3mt9wke.bkt.clouddn.com/grid019.gif)

grid-template-columns: repeat(auto-fill, 100px);效果是这样婶儿的：
![demo](http://pq3mt9wke.bkt.clouddn.com/grid020.gif)
...
grid-row: span 2;
```
![demo](http://pq3mt9wke.bkt.clouddn.com/grid012.png)
...
![demo](http://pq3mt9wke.bkt.clouddn.com/grid014.png)
...
grid-row: 3 / span 2;
```
![demo](http://pq3mt9wke.bkt.clouddn.com/grid013.png)
...
前：![demo](http://pq3mt9wke.bkt.clouddn.com/grid015.png)

后：![demo](http://pq3mt9wke.bkt.clouddn.com/grid016.png)
...
如下图：
![demo](http://pq3mt9wke.bkt.clouddn.com/grid017.png)
...
如下图：
![demo](http://pq3mt9wke.bkt.clouddn.com/grid018.png)
