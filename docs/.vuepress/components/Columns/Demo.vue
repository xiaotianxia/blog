	...
	<div class="columns-wrapper">
		<div class="content-wrapper">
			<div class="col-content" :style="style">
				My father was a self-taught mandolin player. He was one of the best string instrument players in our town. He could not read music, but if he heard a tune a few times, he could play it. When he was younger, <div v-if="showDiv" :style="divStyle" class="span">我是添加的div</div>he was a member of a small country music band.
			...
			<div class="col-content" :style="style">
				...
				<img src="https://denzel.netlify.com/hero.gif" alt="">
				回家变卖典质，父亲还了亏空；又借钱办了丧事。<div v-if="showDiv" :style="divStyle" class="span">我是添加的div</div>这些日子，家中光景很是惨淡，一半为了丧事，一半为了父亲赋闲。丧事完毕，父亲要到南京谋事，我也要回北京念书，我们便同行。
